...
@section('onPage', 'Status Hubungan')
    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Form Master Status Hubungan</h6>
            </div>          
            <form class="card-body" method="POST" enctype="multipart/form-data" action="{{url('/back-master/status-hubungan/save')}}">
                @csrf
                <div class="form-group">
                    <label for="nama_hubungan" class="ml-1">Nama Hubungan :</label>
                    <input type="text" class="form-control  @error('nama_hubungan') is-invalid @enderror" name="nama_hubungan" placeholder="Nama Hubungan..." value="{{old('nama_hubungan')}}">
                    @error('nama_hubungan')
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><center>
                                    <form action="{{url('/back-master/status-hubungan')}}/{{$item->id}}/drop" method="POST" class="d-inline">
                                        @method('delete')
                                        @csrf
