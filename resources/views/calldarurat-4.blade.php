...
<a href="tel:+62-858-1255-7541">
    <img src="{{asset('image/icon/calldarurat.svg')}}" alt="" srcset=""><br><br>
    <p style="text-decoration: none">Telepon Sekarang</p>
</a>
<br><hr style="color: red; border-width: 5px; border-radius: 10%"><br>
<a>
