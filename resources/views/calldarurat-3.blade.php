@extends('layouts.app')
@section('title')
Live Chat Kader Kesehatan
@endsection

@section('chatscript')
<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="930ccc10-b68d-4734-a0f6-fe614f995193";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>
@endsection
